    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-start px-6 pt-24 pb-32 sm:px-10 sm:pt-32 sm:pb-40">
        <h1 className="max-w-3xl text-[44px] font-semibold leading-[1.05] tracking-tight text-foreground sm:text-[64px]">
          The chain records everything.
          <br />
          <span className="text-primary">
            Onyx changes what it records.
          </span>
        </h1>

        <p className="mt-6 max-w-xl text-[16.5px] leading-7 text-foreground/75">
          Move payroll, vendor payments, and treasury transfers through a ZK shielded pool. Amounts stay off the public ledger. Compliance stays audit-ready when you need it.
        </p>
